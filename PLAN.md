...
| 11.9 Cofres de 1K, 5K y 10K | ✅ | `lib/chests.ts` con premios por franjas. Los tres devuelven ~0,88 de media, por el mismo motivo que los regalos. Viven **dentro de la caja de regalos**, en su propia pestaña junto a la de Suerte (`components/chest-panel.tsx`): es el mismo impulso que el regalo de la suerte y en el perfil quedaban lejos del momento de jugárselo. **Verificación:** 8 pruebas, incluida una simulación de 200.000 aperturas por cofre |
