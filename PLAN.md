...
| **Salud** | 110 pruebas en verde (73 servidor + 37 móvil) · TypeScript limpio en `server/` y `mobile/` · empaqueta para Android · `expo prebuild` acepta los plugins de LiveKit |
